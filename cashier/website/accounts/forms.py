...
class CustomAuthenticationForm(AuthenticationForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['username'].widget = forms.TextInput(attrs={'placeholder': 'Email atau Username', 'class': 'form-control'})
        self.fields['password'].widget = forms.PasswordInput(attrs={'placeholder': 'Kata Sandi', 'class': 'form-control'})
